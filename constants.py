...
GAME_STATE_REPLAY = 6
GAME_STATE_MODE_SELECT = 7
GAME_STATE_ACHIEVEMENTS = 8
...
# 도전 모드 설정
TIME_ATTACK_DURATION = 120  # 2분 (초)
PUZZLE_MODE_BALLS = 10      # 퍼즐 모드 공 개수
SURVIVAL_SPEED_INCREASE = 0.1  # 생존 모드 속도 증가율
...
# 업적 시스템 설정
ACHIEVEMENT_NOTIFICATION_DURATION = 3000  # 업적 알림 표시 시간 (밀리세컨드)
PERFECT_ANGLE_TOLERANCE = 2  # 완벽한 각도 허용 오차 (도)
PERFECT_ANGLES = [45, 90, 135]  # 완벽한 각도들
